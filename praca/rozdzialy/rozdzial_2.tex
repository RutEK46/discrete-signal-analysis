...
\begin{figure*}[!htbp]
  ...
  \begin{center}
    ...
    % opis obrazka
    \caption[Ca³kowanie dyskretne metod¹ trapezów]{metoda trapezów - na wykresie mo¿na zauwa¿yæ, ¿e trapezy pokrywaj¹ siê idealnie z ca³¹ funkcj¹, jednak poniewa¿ sam wykres jest przybli¿eniem wartoœci pomiêdzy próbkami nie oznacza to, ¿e ca³ka jest liczona w sposób idealny.}
    % etykieta
