...
\begin{figure*}[!h]
  ...
  \begin{center}
    ...
    %  jeden z nich mo¿e byæ zast¹piony ! - zachowanie proporcji obrazka
    %  w taki sposób mo¿emy skalowaæ tak¿e inne obiekty np. tekst
\subfloat[metoda prostokatow - sposób pierwszy]
{
...
\newline
\subfloat[metoda prostokatow - sposób drugi]
{
    \resizebox{0.8\textwidth}{!}{
...
\newline
    ...
    % opis obrazka
    \caption[Calkowanie dyskretne metoda prostokatow]{Ca³kowanie dyskretne metod¹ prostok¹tów.}

    % etykieta
    \label{Calkowanie dyskretne metoda prostokatow}
  \end{center}
\end{figure*}
