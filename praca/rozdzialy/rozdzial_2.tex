...
\subsubsection{zasady dzia³ania}
Pochodna $f^\prime(x)$ jest liczona jako ró¿nica pomiêdzy wartoœci¹ $f(x)$ w dwóch ró¿nich punktach podzelon¹ przez odleg³oœæ miêdzy tymi punktami $h$ dla $h$ d¹rz¹cego do $0$.
\begin{equation}
