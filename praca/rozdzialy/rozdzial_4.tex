...
\caption{Wynik wskaŸnika MACD - powy¿sze rysunki przedstawiaj¹ wyniki testu wskaŸnika MACD na akcjach 3 spó³ek z okresu 2018 - 2019 }
\end{figure*}
...
\caption{Wynik Wstêg Bollingera dla strategii kup w do³ku cenowym, sprzedaj w szczycie cenowym - powy¿sze rysunki przedstawiaj¹ wyniki testu Wstêg Bollingera na akcjach 3 spó³ek z okresu 2018 - 2019 }
\end{figure*}
...
\caption{Wynik Wstêg Bollingera dla strategii kup w do³ku cenowym, sprzedaj po wyjœciu z do³ku cenowego  - powy¿sze rysunki przedstawiaj¹ wyniki testu Wstêg Bollingera na akcjach 3 spó³ek z okresu 2018 - 2019 }
\end{figure*}
...
\caption{Wynik Wstêg Bollingera dla strategii kup po wyjœciu ze szczytu cenowego, sprzedaj po wejœciu na szczyt cenowy- powy¿sze rysunki przedstawiaj¹ wyniki testu Wstêg Bollingera na akcjach 3 spó³ek z okresu 2018 - 2019 }
\end{figure*}
\subsection{podsumowanie}
...
tutaj przedstawimy testy wskaŸników z zadanym na pocz¹tku kapita³em i iloci¹ akcji, nastêpnie porównamy wyniki i zauwa¿ymy, który wskaŸnik da³ najlepsze wyniki 
